...
For the sake of simplification, we have done this without specifying arguments.
...
# (Dis)similarity measures: metric distances
...
# (Dis)similarity measures: metric distances ![:cube]()
...
After this, look into the numbers, think critically about them, and be ready to chat! (_3-min_)
...
.center[Tip: Compare sites $s_2$ and $s_3$.]
...
1\. Normalizing the data, _i.e._ scaling site vectors to length 1 by dividing species abundances in a given sample by the square-rooted sum of square abundances in all samples as in
