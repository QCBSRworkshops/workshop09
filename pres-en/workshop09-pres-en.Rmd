...
In a PCA, we preserve the maximum amount of variation in the data

In a PCoA, we preserve as best we can the Euclidean distances between each object in multidimensional space

.alert[PCoA can be especially useful when the dataset is wider than it is long.]
