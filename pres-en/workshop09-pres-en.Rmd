...
- Not possible to draw a diagram more than 3D
...
???
Note: Replaced the image to fix the typo "objets"
...
#go through each row, and determine if any value in this row is zero
spe <- spe[row_sub,]
