...
$$D_{7}(x_1,x_2)=1-{{\vert x_1 \cap x_2 \vert}\over{\vert x_1 \cup x_2 \vert}} = 1-{{\vert x_1 \cap x_2 \vert}\over{\vert x_1 \vert + \vert x_2 \vert - \vert x_1 \cap x_2 \vert}} = 1-\frac{a}{a+b+c}$$
where,
