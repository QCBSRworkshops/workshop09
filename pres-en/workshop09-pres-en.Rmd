...
---
# (Dis)similarity measures: semimetric distances
...
In `R`, you can use use the `vegan::vegdist()` function to calculate both Jaccard's and Sørensen's indices:
...
The _Bray-Curtis dissimilarity coefficient_ is a modified version of the Sørensen index and allows for species abundances.
