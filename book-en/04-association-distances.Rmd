...
# plot the dendrogram
plot(hc, 
     main = "Dendrogram of Unweighted Pair Group Method with Arithmetic MeanAgglomerative Clustering",
     hang = -1)
```
...
# plot the dendrogram
plot(hc, 
     main = "Dendrogram of Weighted Pair Group Method with Arithmetic Mean Agglomerative Clustering",
     hang = -1)
```
...
# plot the dendrogram
plot(hc, 
     main = "Dendrogram of Ward's minimum variance Agglomerative Clustering",
     hang = -1)
```
...
# plot the dendrogram
plot(hc, 
     main = "Dendrogram of Ward's D2 minimum variance Agglomerative Clustering",
     hang = -1)
```
...
## Platying with real data: the Doubs fish species data
