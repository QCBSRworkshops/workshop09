...
.pull-left[
Comment notre ACP de zéro se compare à 
...
`vegan::rda()` utilise des mises à l'échelle alternatives. Nous ne les couvrirons pas ici, mais vous pouvez étudier la `vignette("decision-vegan")`.
]
